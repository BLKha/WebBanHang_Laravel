...
<template>
    ...
    <div class="flex gap-2">
        ...
        <Link :href="route('checkout.index')" class="rounded-md px-3 py-2 text-black">
            Quản lý
        </Link>
        |
        <Link :href="route('logout')" method="post" as="button" class="rounded-md px-3 py-2 text-black">
            Đăng xuất
        </Link>
        </template>
        ...
        <!-- Chưa đăng nhập -->
        <template v-else>
        <Link :href="route('login')" class="rounded-md px-3 py-2 text-black">
            Đăng nhập
        </Link>
            <span>|</span>
