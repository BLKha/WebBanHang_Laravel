<template>
    <div>
        <Menu></Menu>
        <h1 class="text-center text-5xl">Quản Danh Mục</h1>
        <div v-if="loading" class="text-center text-blue-600">Loading categories.....</div>
        <div v-else>
            <button @click="openModal(null)" class="bg-blue-600 text-white px-4 py-2 rounded mb-4">Thêm Danh mục SP</button>
                    ...
                    <form @submit.prevent="handleSubmit">
                     ...
                     <div class="flex justify-end">
                      <button type="button" @click="closeModal" class="mr-4 text-gray-500">Cancel</button>
                         <button type="submit" class="hover:bg-teal-500 text-dark px-4 py-2 rounded">
