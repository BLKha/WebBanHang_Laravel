<template>
  ...
  <tbody>
    <tr v-for="category in categories" :key="category.id" class="hover:bg-gray-300">
        <td class="border border-gray-300 px-4 py-2 text-center">{{ category.id }}</td>
      <td class="border-gray-300 px-4 py-2 text-center">{{ category.name }}</td>
      <td class="border-gray-300 px-4 py-2">{{ category.description }}</td>
