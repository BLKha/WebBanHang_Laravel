<template>
    <div>
        ...
        <div v-else>
            <button @click="openModal(null)" class="bg-blue-300 text-white px-4 py-2 rounded mb-4">Thêm Loại SP</button>
  ...
  <tbody>
    <tr v-for="category in categories" :key="category.id" class="hover:bg-teal-100">
