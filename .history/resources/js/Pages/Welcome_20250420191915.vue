                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
                    <div v-for="product in products" :key="product.id" class="border rounded-lg p-4 shadow-lg bg-white flex flex-col justify-between">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-gray-500">Category: <spanp class="text-teal-500">{{ product.category?.name }}</spanp></div>
                            <div class="text-gray-500">Brand: <p class="text-teal-500">{{ product.brand?.name }}</p></div>
                        </div>
